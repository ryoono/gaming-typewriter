...
| BMX055使用9軸センサーモジュール | [廃盤](https://akizukidenshi.com/catalog/g/g113010/) |
| Arduino IDE | ここにバージョンを記載 |

## BMX055モジュールのジャンパ設定

Arduino Pro Micro 5V/16MHz版で使用するため、BMX055モジュールのジャンパを以下のように設定します。
...
これにより、I2Cプルアップを有効化し、電源・信号レベルを5V系で使用します。
